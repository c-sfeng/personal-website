const content = {
  ...
  home: {
    ...
    images: {
      primaryImage: './assets/primary.jpg',
      projectsImage: './assets/projects.jpg',
      resumeImage: './assets/resume.jpg',
      portfolioOne: './assets/portfolio1.jpg',
      portfolioTwo: './assets/portfolio2.jpg',
    },
  },
  projects: {
    projectsSubtitle: '',
    images: {
      primaryImage: './assets/projects-banner.jpg',
    },
  },
  gallery: {
    gallerySubtitle: '',
    images: {
      primaryImage: './assets/gallery-banner.jpg',
    },
    showcase: {
  ...
  urls: {
    ...
    resumeURL: '/resume',
    galleryPersonalURL: '/gallery#personal',
    galleryProfessionalURL: '/gallery#professional',
  },
};
